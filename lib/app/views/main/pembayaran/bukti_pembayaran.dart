    ...
    return Scaffold(
      body: Padding(
        ...
        child: Column(children: [
              ...
              children: [
                Row(
                  children: const [
                    ...
                    Spacer(),
                    Text("26.000", style: TextStyle(fontSize: 16, color: MyPalettes.appOrange))
                  ],
                ),
                ...
                Container(
                  ...
                  width: double.infinity,
                  decoration: BoxDecoration(
                    border: Border.all(color: MyPalettes.appDark),
          ...
          InkWell(
            onTap: () {
              Navigator.pushNamed(context, Routes.pembayaran_berhasil);
            },
            child: Ink(
              width: double.infinity,
              height: 60,
